                        ...
                        <div key={les._id} className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 flex flex-col md:flex-row gap-6">
                            ...
                            <div className="flex-grow">
                                ...
                                <div className="flex flex-wrap gap-3">
                                   ...
                                   {les.fileUrl && (
                                       <a href={`http://localhost:5000${les.fileUrl}`} target="_blank" rel="noreferrer" className="flex items-center gap-1.5 text-sm font-bold text-primary bg-indigo-50 px-4 py-2 rounded-lg hover:bg-indigo-100 transition shadow-sm">
